...
const CryptoDetails: React.FC<Coin> =  () => {
  const { coinId } :Coin  = useParams();
...
console.log(cryptoDetails, coinId, coinHistory);
  return (
     <IonPage>
        <IonHeader>
      <IonToolbar>
    ...
    <IonContent fullscreen>
      ...
      <Col className="coin-desc-link">
        ...
        <Col className="coin-links">
          ...
          {cryptoDetails.links?.map((link : {name: any, url: any, type: any}) => (
